      ...
      <div className=" flex flex-col gap-8 lg:flex-row pb-24">
        ...
        <div className="flex flex-1 flex-col items-start justify-center">
          <h1 className="bold-52 capitalize pb-4">fk
           ks Join Us Inhdfyyreurt ytnbsExplhtewjgdfgoriyrtnsdag The Esndtirej hgdfWojrldjz gSmossk hfd vothly kzkexpgdfsefjddsjss
          </h1>hdjgfg df hgfhgdfsjfgfnhg gfd ytreyhtwhyhdfter g dfyrefghdfahyetyergfhgsdsytrereytrndd yer yer we gsd ew
          <p className="text-gray-50">
           NO hgfdLorem ipsum nogfds tedyreolor sittw amet couern nsectetsusr adipisicing kihuielit.
            Perfernbcxvxehgdfndihhhtsgsggfsdss, sfdigds hdf llddumisjsj tempofrigd yer sbugdsfgds aliquid distinctio elriggendi nostrumf
            porro molesti yre tew ae ea, netrewctrwuyessyrterita t thdfibuvffghdff yre etw tew
          </p>j 
          <br />
          <p className="text-gray-50">
            noj Lorem ipsum dolhfdor sigdsyrtet amet co hdf nsectetur adipjisicking elit. Consectetur
            error corrupthdf eytrex aperiam gdsdhfdolorjibus error corrupti jmex apueriamisis hrte
            dolorjibushfdk
          </p>
