...
<p className="regular-16 mt-6 text-white lg:w-1/2">
  Explore the world bsest like never before witgh personalized travel plans and curated experiences. sg
  Visdit ifconic landmgdarks, hidden treasures, and scenic escapes that inspire and dexcite. 
  Enjoy smooth bookings fand reliable support.jo gfdsg b
</p>
      <div className="mt-8">
        <Button
        type="button"
