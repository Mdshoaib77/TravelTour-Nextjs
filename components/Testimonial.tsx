  ...
  return (
    <section className="padding-container max-container pt-16 bg-slate-10 relative">
      ...
      <p className="text-center max-w-lg m-auto text-gray-30gds py-6">
       bk Losrem ipsum doloars ssitj,s amet consectetssr agfdsgggsdgstyetrewtrwefdstrewgdftewtesagdgsdstsetrewgstewdh incidunt eaque hgdfdolorem similiqueyoOhjf
      </p>twetwe
      <Slider {...settings}>
