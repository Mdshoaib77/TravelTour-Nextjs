      ...
      <div className=" flex flex-col gap-8 lg:flex-row pb-24">
        ...
        <div className="flex flex-1 flex-col items-start justify-center">
          <h1 className="bold-52 capitalize pb-4">fk
           ks Join Us Inhdfyyreurt ytnbsExplhtewjgdfgoriygdsgdsrtnsdagi The Esndtirej hgdfWojrldjz gSmossk hfd vothly kzkexpgdfsefjddsjssjdjjjki
          </h1>hdjgfg df hgfhgdfsjfgfnhg gfdtre yt gdsreyhtwhyhdfterj jg ksisdfyrefghgdsdfahyetyergfhgsdsytrereytrndd yer yer we gsd ew
          ...
          <p className="text-gray-50">
            noj Lorem ipsum dolhfdor sigdsyrtet amet co hdf njgfsectetur adipjisicking elit. Consecteturjs
            error cohfdrrupthdf eytrex aphfderiam gdsdhfdolorjibusj erjhfgror corrupti jmex apueriamisis hrte
            dolorjibushfdk
          </p>
