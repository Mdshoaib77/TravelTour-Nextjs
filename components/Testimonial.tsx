  ...
  return (
    <section className="padding-container max-container pt-16 bg-slate-10 relative">
      ...
      <p className="text-center max-w-lg m-auto text-gray-30 py-6">
       bk Losrem ipsum doloars ssit,s amet consectetsr adipisicing elit. Tenetur iure
        snulla nsepealslsata scxupsidssitaatse incidunt eaque dolorem similiqueyoOhjf
      </p>
      <Slider {...settings}>
