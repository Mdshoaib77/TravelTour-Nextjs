      ...
      <div className=" flex flex-col gap-8 lg:flex-row pb-24">
        ...
        <div className="flex flex-1 flex-col items-start justify-center">
          <h1 className="bold-52 capitalize pb-4">fk
           ks Join Us Inhdfyurt sExplhjgdfgoriyrtnsg The Esndtirej hgdfWojrld gSmosskothly kzkexpgdfsefjddsjss
          </h1>hdfghfnhgfh
          <p className="text-gray-50">
           NO hgfdLorem ipsum no dolor sit amet consectetsusr adipisicing kihuielit.
            Perfernbcxvxehgdfndihgss, sillddum tempofribugdsfgds aliquid distinctio elriggendi nostrumf
            porro molestiae ea, necessitatibuvffghdff
          </p>
          <br />
          <p className="text-gray-50">
            noj Lorem ipsum dolhfdor sit amet consectetur adipjisicking elit. Consectetur
            error corrupthdf eytrex aperiam dolorjibus error corrupti jmex aperiamisis
            dolorjibushfdk
          </p>
