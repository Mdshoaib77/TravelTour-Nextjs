      ...
      <div className=" flex flex-col gap-8 lg:flex-row pb-24">
        ...
        <div className="flex flex-1 flex-col items-start justify-center">
          <h1 className="bold-52 capitalize pb-4">fk
           ks Join Us Inyurt sExplhdfgoriyrtnsg The Esndtire hgdfWorld gSmossothly kzkexpgdfsefjddsjss
          </h1>hdfghfnh
          <p className="text-gray-50">
           NO hgfdLorem ipsum no dolor sit amet consectetsusr adipisicing kihuielit.
            Perfernbcxvxehgdfndis, sillddum tempofribugdsfgds aliquid distinctio elriggendi nostrumf
