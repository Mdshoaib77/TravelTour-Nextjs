...
import React from "react";gfdgfd
fgdsznjzjznhf
const About = () => {gfd
  return (gds
    <section classfdName="max-container padding-container py-24">gfgsddgdfs
      <div className=" flex flex-col gap-8 lg:flex-row pb-24">fgdgfdsfsgdsgd
        ...
        <div className="flex flex-1 flex-cgfsdol items-start justify-icenter">gfdsgdsgfdsggf
          ...
          </h1>hdjgfg df hgdumd nogfddds tedyrbdvebfdoldosr5yosskskz jsgdtitstfwgj am5et fdcokgue4gfdggggdfsgfdfdgdsgdfsrsnklectetsusrg agdipisdficing kihuielit.k
          ...
          <br />gjhgfjhgfgfdgfdfgrdsdgfsdggdsf
          <p className="text-gray-50">fjgfgfgfdgfdsgfdshtgfsdf
